...
* Update Logstash and XHGui links from wmflabs.org to wmcloud.org. (Timo Tijhof) [T289318](https://phabricator.wikimedia.org/T289318)
* Remove unused grant for tools.wmflabs.org. (Timo Tijhof)

### Added

* Add support for Beta Cluster via "beta.wmcloud.org". (Timo Tijhof) [T289318](https://phabricator.wikimedia.org/T289318)
...
* Add "querysort" option. (Ori Livneh) [T138093](https://phabricator.wikimedia.org/T138093)
* Add PHP 7.4 option. (mainframe98) [T312653](https://phabricator.wikimedia.org/T312653)
* Add "Unsupported domain" indicator. (Larissa Gaulia) [T269028](https://phabricator.wikimedia.org/T269028)
...
* popup: Avoid "TypeError" in developer console when using Chrome. (Timo Tijhof) [T294335](https://phabricator.wikimedia.org/T294335)
...
* Use x-request-id header for perf/logging link, instead of `mw.config` wgRequestId. (Timo Tijhof) [T279211](https://phabricator.wikimedia.org/T279211)
...
* Add support for XHGui in Beta Cluster. (Timo Tijhof) [T180761](https://phabricator.wikimedia.org/T180761)
...
* Add new "Inline profile" option. (Timo Tijhof) [T398094](https://phabricator.wikimedia.org/T398094)

### Fixed

* Hide production backend choices when in Beta Cluster.  (Timo Tijhof) [T398093](https://phabricator.wikimedia.org/T398093)
